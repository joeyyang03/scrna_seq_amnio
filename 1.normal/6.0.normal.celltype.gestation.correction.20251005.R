rm(list = ls())
setwd("/share/home/yangjingyi/project/1.BD/up.load/1.normal/6.0.output/")
...
write.csv(x = cor.matrix, row.names = TRUE, file = paste0("6.0.amniocytes.Pearson.correlation.coefficient.selected.",celltype,".20251005.csv"))
