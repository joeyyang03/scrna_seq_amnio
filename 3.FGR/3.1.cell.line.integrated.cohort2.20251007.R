rm(list = ls())
setwd("/share/home/yangjingyi/project/1.BD/up.load/3.FGR/3.1.output/")
...
cellline <- gsub("2.1.cohort2.amnio.", "", cellline)
...
save.image(file = paste0("/share/home/yangjingyi/project/1.BD/up.load/3.FGR/3.1.output/3.1.cohort2.",cellline,".integrated.20250712.RData"))
