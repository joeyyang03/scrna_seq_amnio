rm(list = ls())
setwd("/share/home/yangjingyi/project/1.BD/up.load/3.FGR/4.0.output/")
...
cellline <- gsub(".integrated.20251006.RData", "", cellline)
cellline <- gsub("3.0.cohort1.", "", cellline)
...
########
save.image(file = paste0("/share/home/yangjingyi/project/1.BD/up.load/3.FGR/4.0.output/4.0.cohort1.",cellline,".integrated.singleR.with.inte.cluster.res.0.5.20251007.RData"))

########
load("/share/home/yangjingyi/project/1.BD/up.load/3.FGR/4.0.output/4.0.cohort1.epi.integrated.singleR.with.inte.cluster.res.0.5.20251007.RData")
...
write.csv(x = amnio.epi.metadata, row.names = TRUE, file = "4.0.cohort1.amnio.epi.metadata.res.0.5.20251007.csv")


load("/share/home/yangjingyi/project/1.BD/up.load/3.FGR/4.0.output/4.0.cohort1.hemato.integrated.singleR.with.inte.cluster.res.0.5.20251007.RData")
...
write.csv(x = amnio.hemato.metadata, row.names = TRUE, file = "4.0.cohort1.amnio.hemato.metadata.res.0.5.20251007.csv")
