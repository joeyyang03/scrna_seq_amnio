...
table(cor.matrix.sel[abs(cor.matrix.sel$Pearson.correlation.coefficient) > 0.8,]$organ)


cor.gene <- unique(cor.matrix.sel$gene)

cor.cell.type <- unique(cor.matrix.sel$cell.type)
...
dim(df)
save(df, file = "/share/home/yangjingyi/project/1.BD/up.load/2.model/3.0.output/3.0.amniocytes.with.celltype.cor.without.selection.exp.0.1.df.20251007.Robj")
...
save(df.test, file = "/share/home/yangjingyi/project/1.BD/up.load/2.model/3.0.output/3.0.amniocytes.test.with.celltype.cor.without.selection.exp.0.1.df.20251007.Robj")
#############################################################amnio.FGR.cohort1###################
...
save(df.FGR.cohort1, file = "/share/home/yangjingyi/project/1.BD/up.load/2.model/3.0.output/3.0.amniocytes.FGR.cohort1.with.celltype.cor.without.selection.exp.0.1.df.20251007.Robj")
